...
This protocol is a required execution stage. Generation is not finished until all three gates pass.
...
- [ ] Natural candid front, side, rear, or three-quarter view; not restricted to rear view.
- [ ] Waist/hip-height camera impression.
- [ ] 85–135mm telephoto compression; no obvious wide-angle stretching.
- [ ] View angle is natural and scene-appropriate; avoid staged direct eye contact unless explicitly requested.
...
2. Scan for a repeated face, hair silhouette, top cut, alley/street template, sun direction, body pose, framing template.
